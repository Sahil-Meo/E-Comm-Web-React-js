                ...
                <div className="porduct-variation">
                    ...
                    <div className="quantity-buy">
                        ...
                        <div className="buynow-btn">
                            <Link to='/checkout' onClick={()=>handleAddToCart(product)} className='Btn'>Buy Now</Link>
                        </div>
                        <div className="like-btn">
                            <i onClick={() => handleWishlist(product)} className='fa-regular fa-heart'></i>
                        </div>
                    </div>
                </div>
